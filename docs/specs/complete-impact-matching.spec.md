...
1. **Remote references.** Git-URL bases, OCI artifacts and remote components are not fetched, not resolved, and not matched (F-D12). Listed as a v2 idea in `design.md:583`.
